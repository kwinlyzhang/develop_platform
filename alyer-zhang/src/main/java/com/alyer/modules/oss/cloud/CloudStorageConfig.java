...
public class CloudStorageConfig implements Serializable {
    ...
    public String getFileStorePrefix() { return fileStorePrefix;
    }

    public void setFileStorePrefix(String fileStorePrefix) { this.fileStorePrefix = fileStorePrefix; }
